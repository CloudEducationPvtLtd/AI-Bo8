...
// import { eventServices, brainwaveServicesIcons} from "../constant"
        ...
        <div className="container relative">
            <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb:[6rem]">
                <h1 className="h1 mb-6">
                    Explore the Possibilites of Robotics, AI & ML with {' '}
                    <span className="relative inline-block"> Media <img src={curve} width={624} height={28} alt="Curve" className="absolute top-full left-0 w-full xl:-mt-2"/></span>
                </h1>
                <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg-mb-8">Stay updated with the latest advancements, news, and breakthroughs in robotics technology from our innovative company. Explore our journey and achievements in the world of robotics.</p>
            </div>
        </div>
        <div className="container ">
            <div className="relative">
                ...
                <div className="relative z-1 max-w-[17rem] ml-auto">
                    <h4 className="h4 mb-4">Events</h4>
                    <p className="body-2 mb-[3rem] text-n-3">AI Bo8 unloack the potential of AI powered Events</p>
                    <ul className="body-2">
                ...
                <Generating className='absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2  lg:bottom-8 lg:-translate-x-1/2' text="AI Events is Loding Register Now"/>
                </div>
                </Link>
                <div className="relative grid z-1 gap-5 lg:grid-cols-2">
                    ...
                    <h4 className="h4 mb-4">Media Gallery</h4>
                    <p className="body-2 mb-[3rem] text-n-3">AI Bo8 unloack the potential of AI powered Gallery</p>
                    </div>
                   ...
                   <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h[46rem]">
                        ...
                        <h4 className="h4 mb-4">Technical Blogs & Projects</h4>
                        <p className="body-2 mb-[2rem] text-n-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit dolore quae autem modi officia blanditiis quis illum nihil, voluptates, ratione asperiores nesciunt obcaecati earum ut alias perferendis rerum! Iure, odio.</p>
